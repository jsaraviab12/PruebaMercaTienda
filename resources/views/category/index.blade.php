...
<div id="errorOnDelete" class="alert alert-danger showError" role="alert">
    <strong>¡Cuidado!</strong> @php echo Session::get('error_delete'); @endphp
</div>
<script type="text/javascript">
    setTimeout(function() {
        document.getElementById("errorOnDelete").style.display = "none";
    }, 7000);
</script>
@endif
