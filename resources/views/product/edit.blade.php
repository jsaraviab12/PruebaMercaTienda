...
<div class="container" style="margin:0 auto; position:relative;">
    <form action="/products/{{$product->id}}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" name="price" id="price" class="form-control" tabindex="1" value="{{$product->price}}">
        </div>
        <div>
            <label for="" class="form-label">Cantidad</label>
            <input type="text" name="count" id="count" class="form-control" tabindex="1" value="{{$product->count}}">
        </div>
        <div class="mb-3">
